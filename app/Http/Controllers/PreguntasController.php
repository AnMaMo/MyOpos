...
class PreguntasController extends Controller
{
    ...
    /**
     * Funcion principal del controlador, abrirá la vista Preguntas.Index
     */
     ...
     * En los parametros se le pasara el enunciado y la explicación
     */
    ...
    /**
     * Funcion usada para eliminar una pregunta,
     * En los parametros se le pasara la id de la pregunta a eliminar.
     */
    ...
    /**
     * Funcion usada para editar una pregunta en concreto,
     * En los parametros se le pasara la id de la pregunta, y el nuevo enunciado y la nueva explicación.
     */
    ...
    /**
     * Funcion usada para retornar un array de todas las preguntas existentes,
    ...
    /**
     * Funcion usara para retornar una pregunta en concreto,
     * En los parametros se le pasara la id de la pregunta que se pide.
     */
    ...
    /**
     * Funcion usada para añadir una respuesta,
     * En los parametros se pasara la id de la pregunta a la que se añade la respuesta, La respuesta y si es correcta o no.
     */
    ...
    /**
     * Funcion usada para eliminar una respuesta en concreto,
     * En los parametros se pasara la id de la respuesta que queremos eliminar.
     */
    ...
    /**
     * Funcion usada para editar una respuesta en concreto,
     * En los parametros se pasara la id de la respuesta en concreto, la nueva respuesta y si es correcta o no.
     */
    ...
    /**
     * Funcion usada para obtener una respuesta en concreto,
     * En los parametros se le pasara la id de la respuesta que queremos obtener.
     */
    ...
    /**
     * Funcion usada para obtener todas las respuestas de una pregunta en concreto,
     * En los parametros se le pasara la id de la pregunta que queremos obtener sus respuestas.
     */
